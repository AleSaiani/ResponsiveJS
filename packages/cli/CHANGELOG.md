...
- [`3eec62f`](https://github.com/AleSaiani/ResponsiveJS/commit/3eec62feddde18723b12b6473cd0d4812ddac881) Thanks [@AleSaiani](https://github.com/AleSaiani)! - First public alpha of ResponsiveJS (`r$`).

  One model — **`value = f(width)`**, viewport _and_ container — with two halves that close a
  ...
  **Verification (`design` + `contract` + `cli`)** — measure a page (or a **component**, by
  ...
  _effective_ backgrounds, touch targets with DOM semantics, continuity checks on the measured
...
- Updated dependencies [[`3eec62f`](https://github.com/AleSaiani/ResponsiveJS/commit/3eec62feddde18723b12b6473cd0d4812ddac881)]:
  - @responsivejs/core@1.0.0-alpha.0
  - @responsivejs/contract@1.0.0-alpha.0
  - @responsivejs/design@1.0.0-alpha.0
