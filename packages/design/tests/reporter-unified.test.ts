...
import { formatConsole, formatJSON, formatCompact, formatSARIF } from '../src/report/reporter.js';
...
function unifiedWithViolations() {
    return mergeReports(analyzeStore(store()), {
        ...
        violations: [
            ...
            { rule: 'noOverflow', element: '.a[0]', width: 320, detail: 'right=400 > 320', severity: 'error', fix: { selector: '.a', property: 'max-width', value: '100%', reason: 'contain overflow' } },
        ],
    });
}
